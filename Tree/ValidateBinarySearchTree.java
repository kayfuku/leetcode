...
public class ValidateBinarySearchTree {
	...
	// While traversing the tree, I'm going to keep track of the minimum and maximum for the current node. 
	...
	// O(H) space (O(logN) for balanced, O(N) for not balanced), where H is the height of the input tree, 
