...
public class LinkedListCycle {
	...
	// \text{Number of iterations} = \text{non-cyclic length} = Number of iterations=non-cyclic length=N
	// 
	...
	// Since the speed difference is 1, it takes \dfrac{\text{distance between the 2 runners}}{\text{difference of speed}} 
	// difference of speed distance between the 2 runners loops for the fast runner to catch up with the slow runner. 
	// As the distance is at most "\text{cyclic length K}cyclic length K" and the speed difference is 1, 
	...
	// let Y be the length of the cycle. We know slow moves t, while fast moves 2t. They meet at K where 
