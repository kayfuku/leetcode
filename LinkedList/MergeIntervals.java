...
public class MergeIntervals {
  ...
  private class IntervalComparator implements Comparator<Interval> {
    ...
    public int compare(Interval a, Interval b) {
      // return (a.start.compareTo(b.start); // NG! primitive type does not have
      // compareTo().
      // When the order of args (o1, o2) and the return o1 - o2, the elements are
      // sorted
      // in ascending order.
  ...
  public int[][] merge(int[][] intervals) {
    ...
    // We can simply do this like this.
    // Collections.sort(intvls, (a, b) -> a.start - b.start);
