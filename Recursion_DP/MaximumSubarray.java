...
public class MaximumSubarray {
	...
	// The max up to i-th element is calculated by using the max up to the (i - 1)-th element 
	// and i-th element. We just need to return the maximum sum. 
	...
	// 
	// O(N) time, where N is the total number of elements in the array, since it's one pass along the array. 
	...
	public int maxSubArray(int[] nums) {
		...
		// i starts from 1, not 0! because 'curMaxSum' is set to nums[0] and we add nums[i] to it. 
