...
public class RemoveElement {
	...
	// the number of assignment operation is equal to the number of elements to remove. 
	...
	// In this approach, the number of assignment is equal to the number of elements to remove. 
