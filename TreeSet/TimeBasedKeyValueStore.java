...
public class TimeBasedKeyValueStore {
  ...
  // 1. HashMap + Binary Search (Next solution is good enough)
  // Author: @awice + kei
  // Date : March 13, 2020
  ...
  // According to Note 3, the timestamps for all TimeMap.set operations are
  // strictly increasing.
  ...
  public String get(String key, int timestamp) {
    ...
    int i = Collections.binarySearch(A, new PairGen<Integer, String>(timestamp, ""),
        // The list is sorted by the key of PairGen (timestamp) in ascending order in
        // advance.
    ...
    // Key not found. -(i + 1) is the insertion index, which is defined as the point
    // at which
    // the key would be inserted into the list: the index of the first element
  ...
  // Date : March 13, 2020
  class TimeMap {
    // K: key, V: TreeMap<K: timestamp, V: value>
    // We can use TreeMap.floorKey()
