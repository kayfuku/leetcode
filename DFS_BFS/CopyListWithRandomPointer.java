...
public class CopyListWithRandomPointer {
  ...
  public Node copyRandomList(Node node) {
    ...
    copiedNode.next = this.copyRandomList(node.next);
    copiedNode.random = this.copyRandomList(node.random);
  ...
  public Node getClonedNode(Node node) {
    ...
    this.visited.put(node, copiedNode);
